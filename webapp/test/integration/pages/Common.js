sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblesson/Worklist/app", ".html");
		...
		return Opa5.extend("zjblesson.Worklist.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblesson/Worklist/localService/mockserver"], function (mockserver) {
